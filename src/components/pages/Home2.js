         ...
         <div className="App" >
             <div className="App-container">
              <Container>
                ...
                <Row className="justify-content-md-center gridRow">
                    <ImageCard animation="fade-up-left"  img={frontYard}  text={"Praesent semper feugiat nibh sed pulvinar proin. Feugiat in fermentum posuere urna nec tincidunt. A iaculis at erat pellentesque. Donec massa sapien faucibus et. Eget mauris pharetra et ultrices neque. Facilisis magna etiam tempor orci eu lobortis elementum. Pellentesque pulvinar pellentesque habitant morbi. Mattis aliquam faucibus purus in massa tempor nec feugiat. Dui nunc mattis enim ut. Imperdiet proin fermentum leo vel orci porta non. Ac felis donec et odio pellentesque."} />
                </Row>
                <Row className="justify-content-md-center gridRow">
                    <ImageCard animation="fade-up-right" img={backyard} text={"Volutpat consequat mauris nunc congue nisi. Sit amet nisl purus in mollis nunc sed id. Felis bibendum ut tristique et egestas quis ipsum suspendisse. Dictum at tempor commodo ullamcorper. Tortor posuere ac ut consequat semper viverra. Adipiscing tristique risus nec feugiat in. Vulputate mi sit amet mauris. Porttitor massa id neque aliquam vestibulum. Dignissim enim sit amet venenatis urna cursus eget. Suspendisse faucibus interdum posuere lorem. At varius vel pharetra vel turpis nunc eget lorem dolor. In arcu cursus euismod quis viverra nibh. Diam vulputate ut pharetra sit amet aliquam id diam."} />
                </Row>
              </Container>
             </div>
         </div>
